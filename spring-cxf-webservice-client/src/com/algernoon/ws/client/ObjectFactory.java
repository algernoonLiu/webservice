 ...
 * generated in the com.algernoon.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://ws.algernoon.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://ws.algernoon.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.algernoon.ws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.algernoon.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.algernoon.com/", name = "queryWeather")
